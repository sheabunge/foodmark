...
for logger in (tornado.log.access_log, tornado.log.app_log, tornado.log.gen_log, log):
...
class Server:
    ...
    def run(self):
        ...
        log.info('Reloading... waiting for requests on http://{}:{}'.format(self.hostname or 'localhost', self.port))
